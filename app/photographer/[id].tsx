...
import { MapPin, Star, Camera, ShoppingBag } from 'lucide-react-native';
...
export default function PhotographerDetailScreen() {
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        const res = await api.get(`/photographers/${id}/`);
        setData(res.data);
      } catch (e) {
        console.error(e);
  ...
  const handleAddToCart = () => {
    ...
    Alert.alert("Dodano", "Fotograf został dodany do koszyka");
  };
            ...
            <View className="flex-row justify-between mb-8 border-b border-stone-200 pb-6">
                ...
                <View className="items-end">
                    ...
                    <View className="flex-row items-center gap-2">
                        ...
                        <Text className="text-xl font-bold text-stone-900">Fotografia</Text>
                    </View>
                </View>
            </View>

            <Text className="text-lg font-bold text-stone-900 mb-2">O fotografie</Text>
